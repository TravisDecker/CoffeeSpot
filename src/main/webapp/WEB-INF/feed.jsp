        ...
        <div class="w3-col m7">
                    ...
                    <div class="w3-card w3-round w3-white">
                        <div class="w3-container w3-padding">
                            <form:form action="/auth/coffeepost" method="POST" modelAttribute="coffeePostDto">
                                <form:input path="body" cssClass="w3-border w3-padding"/><br><br>
            ...
            <c:forEach var="post" items="${feedPosts}">
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <h4><c:out value="${post.user.username}"/></h4><br>
                    <hr class="w3-clear">
                    <p><c:out value="${post.postBody}"/></p>
